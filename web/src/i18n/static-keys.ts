...
export const STATIC_I18N_KEYS = [
  ...
  // Native public documentation (keys selected from route metadata at runtime)
  'docs.groups.quickStart',
  'docs.groups.cliTools',
  'docs.groups.clients',
  'docs.groups.sdk',
  'docs.groups.troubleshooting',
  'docs.guides.quickStart.title',
  'docs.guides.quickStart.summary',
  'docs.guides.imageGen.title',
  'docs.guides.imageGen.summary',
  'docs.guides.ccSwitch.title',
  'docs.guides.ccSwitch.summary',
  'docs.guides.claudeCode.title',
  'docs.guides.claudeCode.summary',
  'docs.guides.codexCli.title',
  'docs.guides.codexCli.summary',
  'docs.guides.cherryStudio.title',
  'docs.guides.cherryStudio.summary',
  'docs.guides.immersiveTranslate.title',
  'docs.guides.immersiveTranslate.summary',
  'docs.guides.openaiSdk.title',
  'docs.guides.openaiSdk.summary',
  'docs.guides.anthropicSdk.title',
  'docs.guides.anthropicSdk.summary',
  'docs.guides.troubleshooting.title',
  'docs.guides.troubleshooting.summary',
